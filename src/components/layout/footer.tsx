    ...
    <footer className="border-t border-border bg-muted/50 pb-14 md:pb-0">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div>
            <Link href="/" className="inline-block">
              <Image
                ...
                width={250}
                height={73}
                className="h-12 w-auto dark:brightness-200 dark:contrast-75"
              />
            </Link>
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a
                href="https://www.instagram.com/meethubfinancial?utm_source=qr&igsh=NnIwdHNuZTdqank0"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
        ...
        <div className="mt-8 border-t border-border pt-6 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Meet Hub Financial Services. All rights
            reserved.
          </p>
        </div>
      </div>
